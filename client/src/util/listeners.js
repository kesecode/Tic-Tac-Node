...
document.querySelector('#say').addEventListener('click', onFormSubmitted);

document.querySelector('#login-form').addEventListener('submit', onChoseName);

document.querySelector('#matchmaking').addEventListener('click', onMatchmaking);

document.querySelector('#legal-notice').addEventListener('click', onLegalNotice);

document.querySelector('#lobby').addEventListener('click', onLobby);

document.querySelector('#quit').addEventListener('click', onQuit);
...
document.querySelector('#dark-theme').addEventListener('click', onDark);

document.querySelector('#light-theme').addEventListener('click', onLight);

document.querySelector('#color-theme').addEventListener('click', onColor);
