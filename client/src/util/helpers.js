...
const updateTurnBatch = () => {
	let turnBatch = document.getElementById('turnBatch');
...
const updateScoreBatch = (clientScore, opponentScore) => {
	document.getElementById('scoreBatch').innerHTML =
		'You   ' + clientScore + ' : ' + opponentScore + '   ' + matchParameters.opponentsName;
};
