...
//Generated localhost certificate for testing purposes, 
//have a look at the comment at the bottom of this file to see how to generate a new one
const privateKey = fs.readFileSync( './sslFiles/localhost.key', 'utf8');
const certificate = fs.readFileSync( './sslFiles/localhost.crt', 'utf8');
